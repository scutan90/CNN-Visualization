...
![](E:/CNN-Visualization/img/depooling1.png)
...
![](E:/CNN-Visualization/img/depooling2.png)
...
作者给我们显示了，在网络训练过程中，每一层学习到的特征是怎么变化的，上面每一整张图片是网络的某一层特征图，然后每一行有8个小图片，分别表示网络epochs次数为：1、2、5、10、20、30、40、64的特征图：
  ...
  ![](E:/CNN-Visualization/img/feature_v3.png)
...
![](E:/CNN-Visualization/img/opv1.jpg)
...
![](E:/CNN-Visualization/img/opv2.jpg)
...
![](E:/CNN-Visualization/img/opv5.jpg)
...
![](E:/CNN-Visualization/img/opv6.jpg)

第一个Inception层就已经显示出了一些有意思的纹理。由于每个神经元只有一个很小的感受野，所以整个通道的可视化结果就像是小块纹理反复拼贴的结果。

**3b层**

![](E:/CNN-Visualization/img/opv7.jpg)

纹理变得复杂了一些，但还都是比较局部的特征

**4a层**

![](E:/CNN-Visualization/img/opv8.jpg)
